...
base_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'app', 'lucas_organic_carbon')


# demo cases
demo_cases = {
    'Lucas Organic Carbon (PCA)': {
         'target': os.path.join(base_path, 'target', 'lucas_organic_carbon_target.csv'),
        'training': os.path.join(base_path, 'training_test', 'compressed_data.csv')
    },
    'Lucas Organic Carbon (AE)': {
        'target': os.path.join(base_path, 'target', 'lucas_organic_carbon_target.csv'),
        'training': os.path.join(base_path, 'training_test', 'autoencoder_predictions.csv')
    },
